...
public class Start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LZ78 Compresser");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(reader, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(Browse)))
                .addGap(25, 25, 25))
            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(reader, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Browse))
    ...
    private void BrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BrowseActionPerformed
		...
		if (returnValue == JFileChooser.APPROVE_OPTION) {
			File selectedFile = get.getSelectedFile();
                ...
                {
                    Start f = new Start();
                        JOptionPane.showMessageDialog(f,"Please Choose some file");  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (g.contains(".txt"))
        {
            obj.MainProccess(g);
            Start f = new Start();
            JOptionPane.showMessageDialog(f,"Compressed Succeessfully :D");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        obj.DeCompressProcess(reader.getText());
        Start f = new Start();
